...
public class Uebung1136Buch {
    ...
    public static CharSequence decodeToken (String token) {
        if (token.isEmpty()) {
            return "";
        }
        if (token.length() == 1) {
    ...
    public static String decompress(String string) {
        ...
        Matcher pattern = Pattern.compile("([^0-9])(\\d*)").matcher(string);
    ...
    public static void main(String[] args) {
        System.out.println(compress("Hallo"));
    }
